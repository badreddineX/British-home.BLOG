const ALLOWED_ORIGIN = 'https://britishhomeinterior.co.uk';
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: Georgia, serif; max-width: 520px; margin: 0 auto; padding: 2rem; background: #FAF7F4; border: 1px solid #E8E0D8;">
            ...
            <p style="font-size: 1.05rem; color: #1A1A1A; font-weight: bold; background: #fff; padding: 0.75rem 1rem; border-left: 3px solid #B89A6A; margin: 0 0 1.5rem;">${escapeHtml(email)}</p>
