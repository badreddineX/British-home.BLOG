...
> Note: The offer and Product Content for Book 06 was built for **SmallSpaceHome.ca** (Canadian audience). See the SmallSpaceHome.BLOG repo, branch `claude/hormozi-offer-small-space-home-1zrmf4`, for the full `dig prod/books/06-small-living-room-layout-fix/Product Content.md`.
...
**Brand palette (cad — SmallSpaceHome):**  
...
BODY COPY (cream, light sans, 12pt, ~120 words):
