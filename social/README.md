...
| File | What |
|---|---|
| `../social-posts/CAPTIONS-UK.md` | source captions, one block per post (human-written) |
| `../social-posts/ready-UK/NN-<slug>.jpg` | rendered post images, git-tracked → public raw URLs |
| `build-queue.mjs` | captions + images → `queue.json` |
| `queue.json` | machine-readable queue (posts) |
...
1. Add a caption block to `../social-posts/CAPTIONS-UK.md`
2. Drop the rendered image at `../social-posts/ready-UK/NN-<slug>.jpg`
