...
For flat-sharers or couples sharing a living room, a storage bunk unit cuts costs and clutter. John Lewis’ ‘Urban Space Storage Bunk Unit’ (£229) isn’t a real bunk bed — it’s two stacked storage units with drawers and shelves, each holding up to 25kg. It works as a twin bedroom solution in a student flat: the bottom section holds shoes, the top books and a lamp, and the gap underneath can house a vacuum cleaner. No wall fixing needed, and the compact footprint (just 60cm wide) made sense in a tiny hallway. For renters: it’s freestanding and stable — no wobble.

## 7. Can a Fold-Down Table Use Tension Rod Support Instead of Drilling?

If drilling into your wall isn’t an option (and your landlord won’t budge), a fold-down table on tension rods is a reliable workaround. Start with IKEA’s ‘NORDMÖRE’ folding table (£22) and a heavy-duty tension rod (B&Q’s 75cm model, ~£8). Fix the rod ends with no-damage adhesive mounts such as Loctite® Repair Mount (£5), which you can take with you when you leave. The table folds down in seconds and supports up to 10kg — great for a quick dining nook or even a desk. It’s not permanent, not obvious, and won’t affect your deposit.

## 8. Can Modular Shelving Adapt as Your Needs Change?

Renter living means your space will evolve — maybe you start with a desk, then switch to a yoga corner. Modular shelving units that snap together (no tools) are the answer. Next Home’s ‘Malm’ 3-tier shelving (£38) is widely available and stacks vertically to save floor space. Personalise it with removable fabric panels (£3 each on Amazon UK) to hide messy cables or plant pots; the metal frame stays plumb without wall anchors. The feet are felt-lined so they won’t scratch laminate or tile. At 80cm tall, they fit under most windows too — ideal for narrow flats.
