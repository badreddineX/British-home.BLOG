...
excerpt: "Cleaning, damage and redecoration cause the vast majority of UK deposit deductions — and most of it traces back to decor decisions made during the tenancy. Here's the real data and how to avoid it."
tldr:
  - "Cleaning is the single most disputed deposit deduction in the UK — 29.38% of all claims in 2025, up from 24.57% in 2021 (DPS data)."
  - "The average deposit deduction is £250; 29% of affected renters lose more than £500, and 16% lose more than £750."
  - "Only about 1% of tenancies ever reach formal adjudication — but when they do, tenants win the full amount in 22.8% of cases and split awards happen in the majority."
  - "A landlord legally cannot charge for 'fair wear and tear' or for leaving the property in better condition than at check-in (the 'betterment' rule) — most of what gets wrongly deducted falls into one of these two categories."
faqs:
  - q: "What can a landlord legally deduct from a deposit in the UK?"
    a: "A landlord can deduct for unpaid rent, damage beyond fair wear and tear, missing items, and professional cleaning if the property wasn't returned to the standard it was rented at (per the inventory). They cannot charge for fair wear and tear, or for 'betterment' — leaving the property in better condition than at check-in, such as a full replacement when a repair or depreciated-value charge would do."
  - q: "What is the average deposit deduction in the UK?"
    a: "The average deduction is around £250, based on 2025 deposit scheme data. About 29% of renters who face a deduction lose more than £500, and 16% lose more than £750. Cleaning accounts for the largest single share of claims at 29.38%, followed by damage (18.42%), rent arrears (16.45%), and redecoration (10.88%)."
  - q: "Can a landlord charge for painting or redecoration?"
    a: "Only if the walls need genuine repair beyond normal fading and minor marks — a landlord cannot charge for a full repaint just because the colour isn't to their taste, or because of light scuffing from normal living. Nail holes for hanging pictures are generally treated as fair wear and tear if reasonable in number and filled before you leave; large holes, unfilled damage, or an unauthorised colour change are more likely to be chargeable."
  - q: "Do I have to professionally clean before moving out UK?"
...
<figure>
  <svg viewBox="0 0 560 300" style="max-width: 100%; height: auto; font-family: 'Inter', system-ui, sans-serif" role="img" aria-label="Bar chart: share of UK deposit disputes by category, 2025 — cleaning 29.38%, damage 18.42%, rent arrears 16.45%, redecoration 10.88%">
    <title>Share of UK Deposit Disputes by Category (2025)</title>
    <desc>Cleaning 29.38%, damage 18.42%, rent arrears 16.45%, redecoration 10.88%. Source: DPS deposit deduction data, reported via The Intermediary and Property Reporter, 2026.</desc>
    <line x1="170" y1="30" x2="170" y2="230" stroke="currentColor" opacity="0.3" />
    <rect x="170" y="35" width="255" height="38" fill="#8b6b3f" />
    <text x="164" y="59" text-anchor="end" font-size="13" fill="currentColor" opacity="0.8">Cleaning</text>
    <text x="431" y="59" font-size="13" font-weight="800" fill="currentColor">29.38%</text>
    <rect x="170" y="83" width="160" height="38" fill="#a9855a" />
    <text x="164" y="107" text-anchor="end" font-size="13" fill="currentColor" opacity="0.8">Damage</text>
    <text x="336" y="107" font-size="13" font-weight="800" fill="currentColor">18.42%</text>
    <rect x="170" y="131" width="143" height="38" fill="#c6a578" />
    <text x="164" y="155" text-anchor="end" font-size="13" fill="currentColor" opacity="0.8">Rent arrears</text>
    <text x="319" y="155" font-size="13" font-weight="800" fill="currentColor">16.45%</text>
    <rect x="170" y="179" width="94" height="38" fill="#dcc39c" />
    <text x="164" y="203" text-anchor="end" font-size="13" fill="currentColor" opacity="0.8">Redecoration</text>
    <text x="270" y="203" font-size="13" font-weight="800" fill="currentColor">10.88%</text>
    <text x="280" y="255" text-anchor="middle" font-size="10" fill="currentColor" opacity="0.35">
      Remaining share = gardens, missing items and other categories. Source: DPS 2025 data (2026 reporting).
    </text>
  </svg>
</figure>
...
- **Fair wear and tear.** A landlord cannot charge for the ordinary effects of everyday living — faded paint, worn carpet in a hallway, small scuffs. The length of your tenancy matters here: what counts as fair wear and tear after five years is different from after five months ([Shelter England](https://england.shelter.org.uk/housing_advice/tenancy_deposits/what_can_your_landlord_deduct_from_your_deposit)).
...
- **During the tenancy:** keep to reversible, renter-safe changes — see [rented flat makeover ideas](/blog/rented-flat-makeover-uk/) for the full deposit-safe playbook, from Command strips to peel-and-stick wallpaper.
...
Related reading: [Rented Flat Makeover Ideas UK](/blog/rented-flat-makeover-uk/) for the full deposit-safe decorating playbook, [Renter-Friendly Living Room Ideas UK](/blog/renter-friendly-living-room-ideas-uk/), and [Renter-Friendly Bedroom Ideas UK](/blog/renter-friendly-bedroom-ideas-uk/) for room-by-room detail.
